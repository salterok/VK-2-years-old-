...
namespace VK {
    ...
    public partial class VKApiManager {
        ...
        public class Newsfeed : VKAPIBranch {
			...
			private string get(IdList source_ids, Filter filters, DateTime? start_time, DateTime? end_time, System.Int32? offset, string from, System.Int32? count, int? max_photos)
			{
            ...
            /// <param name="max_photos">Максимальное количество фотографий, информацию о которых необходимо вернуть</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string Get(IdList source_ids = null, Filter filters = null, DateTime? start_time = null, DateTime? end_time = null, System.Int32? offset = null, string from = null, System.Int32? count = null, System.Int32? max_photos = null) {
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string search(string q, System.Int32? count, System.Int32? offset, DateTime? start_time, DateTime? end_time, long? start_id, bool? extended) {
            ...
            /// <param name="extended">указывается 1 если необходимо получить информацию о пользователе или группе, разместившей запись</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string Search(string q, System.Int32? count = null, System.Int32? offset = null, DateTime? start_time = null, DateTime? end_time = null, System.Int64? start_id = null, System.Boolean? extended = null) {
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
			private string getBanned(bool? extended, ProfileFields? fields)
			{
				manager.AddValueByName("@extended", extended);
				manager.AddValueByName("@fields", fields);
                return GetResponse("getBanned");
            }
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
			public string GetBanned(ProfileFields? fields = null, System.Boolean? extended = null)
			{
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string addBan(IdList uids, IdList gids) {
                manager.AddValueByName("@uids", uids);
                manager.AddValueByName("@gids", gids);
                return GetResponse("addBan");
            }
            ...
            /// <param name="gids">перечисленные через запятую идентификаторы групп пользователя, новости от которых необходимо скрыть из ленты новостей текущего пользователя</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string AddBan(IdList uids, IdList gids = null) {
            ...
            /// <param name="gids">перечисленные через запятую идентификаторы групп пользователя, новости от которых необходимо скрыть из ленты новостей текущего пользователя</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string AddBan(IdList gids) {
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string deleteBan(IdList uids, IdList gids) {
                manager.AddValueByName("@uids", uids);
                manager.AddValueByName("@gids", gids);
                return GetResponse("deleteBan");
            }
            ...
            /// <param name="gids">перечисленные через запятую идентификаторы групп пользователя, новости от которых необходимо вернуть в ленту новостей текущего пользователя</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string DeleteBan(IdList uids, IdList gids = null) {
            ...
            /// <param name="gids">перечисленные через запятую идентификаторы групп пользователя, новости от которых необходимо вернуть в ленту новостей текущего пользователя</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            public string DeleteBan(IdList gids) {
