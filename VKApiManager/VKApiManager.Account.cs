...
namespace VK {
    ...
    public partial class VKApiManager {
        ...
        public class Account : VKAPIBranch {
            ...
            private string importContacts(string contacts) {
                manager.AddValueByName("@contacts", contacts);
                return GetResponse("importContacts");
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string registerDevice(string token, string device_model, string system_version, string no_text) {
                ...
                return GetResponse("registerDevice");
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string unregisterDevice(string token) {
                manager.AddValueByName("@token", token);
                return GetResponse("unregisterDevice");
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private string setSilenceMode(string token, string time) {
                manager.AddValueByName("@token", token);
                manager.AddValueByName("@time", time);
                return GetResponse("setSilenceMode");
            }
            #endregion
