...
namespace VK {
    ...
    public partial class VKApiManager {
        ...
        public class Notes : VKAPIBranch {
            ...
            /// <param name="offset">смещение, необходимое для выборки определенного подмножества заметок</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getFriendsNotes(System.Int32? count, System.Int32? offset) {
                manager.AddValueByName("@count", count);
                manager.AddValueByName("@offset", offset);
                return new VKResponseBase(GetResponse("getFriendsNotes"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase add(string title, string text, string privacy, string comment_privacy) {
            ...
            /// <param name="comment_privacy">уровень доступа к комментированию заметки</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase edit(string nid, string title, string text, string privacy, string comment_privacy) {
                manager.AddValueByName("@nid", nid);
                manager.AddValueByName("@title", title);
                manager.AddValueByName("@text", text);
                manager.AddValueByName("@privacy", privacy);
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase delete(string nid) {
                manager.AddValueByName("@nid", nid);
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getComments(string nid, System.Int64? owner_id, SortOrder sort, System.Int32? count, System.Int32? offset) {
                manager.AddValueByName("@nid", nid);
                manager.AddValueByName("@owner_id", owner_id);
                manager.AddValueByName("@sort", sort);
                manager.AddValueByName("@count", count);
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase createComment(string nid, System.Int64? owner_id, string reply_to, string message) {
                manager.AddValueByName("@nid", nid);
                manager.AddValueByName("@owner_id", owner_id);
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase editComment(string сid, System.Int64? owner_id, string message) {
            ...
            /// <param name="owner_id">идентификатор пользователя, владельца заметки (по-умолчанию - текущий пользователь)</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase deleteComment(string сid, System.Int64? owner_id) {
                manager.AddValueByName("@сid", сid);
                manager.AddValueByName("@owner_id", owner_id);
            ...
            /// <param name="owner_id">идентификатор пользователя, владельца заметки (по умолчанию - текущий пользователь)</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase restoreComment(string сid, System.Int64? owner_id) {
                manager.AddValueByName("@сid", сid);
                manager.AddValueByName("@owner_id", owner_id);
