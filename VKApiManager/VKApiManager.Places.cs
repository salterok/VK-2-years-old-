...
namespace VK {
    ...
    public partial class VKApiManager {
        ...
        public class Places : VKAPIBranch {
            ...
            private VKResponseBase add(string title, string latitude, string longitude, string type, string country, string city, string address) {
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getById(string places) {
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase search(string latitude, string longitude, string q, string radius) {
                manager.AddValueByName("@latitude", latitude);
                manager.AddValueByName("@longitude", longitude);
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase checkin(string place_id, string text, string latitude, string longitude, string services, System.Boolean? friends_only) {
                ...
                return new VKResponseBase(GetResponse("checkin"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getCheckins(string latitude, string longitude, string place, System.Int64? uid, System.Int32? offset, System.Int32? count, string timestamp, System.Boolean? friends_only, string need_places) {
                manager.AddValueByName("@latitude", latitude);
                manager.AddValueByName("@longitude", longitude);
                ...
                return new VKResponseBase(GetResponse("getCheckins"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getTypes() {
                return new VKResponseBase(GetResponse("getTypes"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getCountries(string need_full, string code) {
                manager.AddValueByName("@need_full", need_full);
                manager.AddValueByName("@code", code);
                return new VKResponseBase(GetResponse("getCountries"), IsXMLResponse);
            }
            #endregion
            ...
            /// <param name="q">строка поискового запроса</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getCities(string country, string q) {
                manager.AddValueByName("@country", country);
                manager.AddValueByName("@q", q);
                return new VKResponseBase(GetResponse("getCities"), IsXMLResponse);
            }
            #endregion
            ...
            /// <param name="q">строка поискового запроса</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getRegions(string country, string q) {
                manager.AddValueByName("@country", country);
                manager.AddValueByName("@q", q);
                return new VKResponseBase(GetResponse("getRegions"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getCountryById(string cids) {
                manager.AddValueByName("@cids", cids);
                return new VKResponseBase(GetResponse("getCountryById"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getCityById(string cids) {
                manager.AddValueByName("@cids", cids);
                return new VKResponseBase(GetResponse("getCityById"), IsXMLResponse);
            }
            #endregion
            ...
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase getStreetById() {
                return new VKResponseBase(GetResponse("getStreetById"), IsXMLResponse);
            }
            #endregion
        }
    }
