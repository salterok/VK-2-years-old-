...
namespace VK {
    ...
    public partial class VKApiManager {
        ...
        public class Likes : VKAPIBranch {
            ...
            private VKResponseBase add(System.Int64? owner_id, string type, string item_id) {
            ...
            /// <param name="item_id">идентификатор Like-объекта</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase delete(System.Int64? owner_id, string type, string item_id) {
                manager.AddValueByName("@owner_id", owner_id);
                manager.AddValueByName("@type", type);
                manager.AddValueByName("@item_id", item_id);
            ...
            /// <param name="item_id">идентификатор Like-объекта</param>
            /// <returns>Ответ сервера в XML или JSON формате.</returns>
            private VKResponseBase isLiked(string user_id, System.Int64? owner_id, string type, string item_id) {
                manager.AddValueByName("@user_id", user_id);
                manager.AddValueByName("@owner_id", owner_id);
                manager.AddValueByName("@type", type);
                manager.AddValueByName("@item_id", item_id);
                return new VKResponseBase(GetResponse("isLiked"), IsXMLResponse);
            }
            #endregion
        }
    }
